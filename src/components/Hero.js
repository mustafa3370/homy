...
const Hero = () => {
  ...
  return (
    <section className=" h-[850px] w-full bg-hero bg-right bg-cover bg-no-repeat text-black pt-[225px] pb-[254px] relative mb-12 lg:bg-center lg:mb-28">
      <div className="container mx-auto text-center">
        ...
        rounded-md backdrop-blur-md transition lg:px-[80px] lg:py-[16px] lg:mb-[180px]'>{buttonText}</button>
        {/*stat*/}
        <div>
          <Stats/>
        </div>
